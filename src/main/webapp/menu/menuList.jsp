...
<div id="system_function_functionList" class="easyui-layout" fit="true"><%--   update-end--Author:duanql  Date:20130619 for：操作按钮窗口显示控制--%>
    <div region="center" style="padding: 1px;"><t:datagrid name="functionList" title="菜单管理" actionUrl="menuController.do?menuGrid" idField="id" treegrid="true" pagination="false">
        ...
        <t:dgDelOpt url="menuController.do?del&id={id}" title="删除"></t:dgDelOpt>
        ...
        <t:dgToolBar title="菜单录入" icon="icon-add" url="menuController.do?addorupdate" funname="addFun"></t:dgToolBar>
        <t:dgToolBar title="菜单编辑" icon="icon-edit" url="menuController.do?addorupdate" funname="update"></t:dgToolBar>
    </t:datagrid></div>
</div>
<%--   update-start--Author:duanql  Date:20130619 for：操作按钮窗口显示控制--%>
